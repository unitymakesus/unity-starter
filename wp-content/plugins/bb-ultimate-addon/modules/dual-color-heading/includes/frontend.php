...
<div class="uabb-module-content uabb-dual-color-heading <?php echo esc_attr( $alignment ); ?> <?php echo esc_attr( $settings->responsive_compatibility ); ?>">
	...
	<?php if ( ! empty( $settings->first_heading_link ) ) : ?>
		<a href="<?php echo esc_url( $settings->first_heading_link ); ?>" title="<?php echo esc_attr( $settings->first_heading_text ); ?>" target="<?php echo esc_attr( $settings->first_heading_link_target ); ?>" <?php BB_Ultimate_Addon_Helper::get_link_rel( $settings->first_heading_link_target, $first_heading_link_nofollow, 1 ); ?>>
	<?php endif; ?>
	...
	<?php if ( ! empty( $settings->second_heading_link ) ) : ?>
		<a href="<?php echo esc_attr( $settings->second_heading_link ); ?>" title="<?php echo esc_attr( $settings->second_heading_text ); ?>" target="<?php echo esc_attr( $settings->second_heading_link_target ); ?>" <?php BB_Ultimate_Addon_Helper::get_link_rel( $settings->second_heading_link_target, $second_heading_link_nofollow, 1 ); ?>>
	<?php endif; ?>
