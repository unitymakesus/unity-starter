	...
	<div class="uabb-image-carousel-item <?php echo ( ( 'none' !== $settings->click_action ) && ! empty( $photo->link ) ) ? 'uabb-image-carousel-link' : ''; ?>">
		<div class="uabb-image-carousel-content">
																				<?php if ( 'none' !== $settings->click_action ) : ?>
																					...
																					?>
			<a href="<?php echo esc_url( $click_action_link ); ?>" target="<?php echo esc_attr( $click_action_target ); ?>" <?php BB_Ultimate_Addon_Helper::get_link_rel( $click_action_target, $settings->click_action_nofollow, 1 ); ?> data-caption="<?php echo esc_attr( $photo->caption ); ?>">
			<?php endif; ?>
